...
<Callout type="info">
  ...
  [GitHub repository](https://github.com/Village-Wellth/next-admin/issues). **CLI currently only supports
  Next.js projects.**
</Callout>
...
```bash
npx @village-wellth/next-admin-cli@latest init --help
```
...
yarn add @village-wellth/next-admin @village-wellth/next-admin-generator-prisma
  ...
  <Tabs.Tab>
    ```bash copy
npm install -S @village-wellth/next-admin @village-wellth/next-admin-generator-prisma
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
pnpm add @village-wellth/next-admin @village-wellth/next-admin-generator-prisma
    ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['App router', 'Pages router']}>
  <Tabs.Tab>
    ...
    import { PageProps } from "@village-wellth/next-admin";
