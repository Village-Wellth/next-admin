...
```ts
import { NextAdminRouterAdapter, NextAdmin, MainLayout } from '@village-wellth/next-admin/adapters/<your-framework>'
```
...
```ts
import { createRouterAdapter } from "@village-wellth/next-admin/adapters/context";
import { createNextAdminComponents } from "@village-wellth/next-admin/adapters/components";
import type { RouterInterface } from '@village-wellth/next-admin/adapters/types'
