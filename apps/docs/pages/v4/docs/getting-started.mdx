...
<Steps>
  ...
  <Tabs items={["yarn", "npm", "pnpm"]}>
    <Tabs.Tab>
      ```bash copy
  yarn add @village-wellth/next-admin prisma-json-schema-generator
      ```

    </Tabs.Tab>
    <Tabs.Tab>
      ```bash copy
  npm install -S @village-wellth/next-admin prisma-json-schema-generator
      ```
    </Tabs.Tab>
    <Tabs.Tab>
      ```bash copy
  pnpm install -S @village-wellth/next-admin prisma-json-schema-generator
      ```
    </Tabs.Tab>
  </Tabs>
  ...
  module.exports = {
    ...
    darkMode: "class",
    presets: [require("@village-wellth/next-admin/dist/preset")],
  };
  ```
...
<Tabs items={["yarn", "npm", "pnpm"]}>
  ...
  <Tabs items={['App router', 'Pages router']}>
    ...
    import { ActionParams, ModelName } from "@village-wellth/next-admin";
    import {
      SearchPaginatedResourceParams,
      deleteResourceItems,
      searchPaginatedResource,
      submitForm,
    } from "@village-wellth/next-admin/dist/actions";
    ...
    import { NextAdmin, AdminComponentProps } from "@village-wellth/next-admin";
    ...
    export const getServerSideProps: GetServerSideProps = async ({ req, res }) => {
      const { nextAdminRouter } = await import(
        "@village-wellth/next-admin/dist/router"
      );
