...
Some of the snippets are implemented in the example project. You can check them out in the [example project](https://next-admin-po.vercel.app) or in the [source code](https://github.com/Village-Wellth/next-admin/tree/main/apps/example).
...
- [app/api/users/export/route.ts](https://github.com/Village-Wellth/next-admin/tree/main/apps/example/app/api/users/export/route.ts)
- [app/api/posts/export/route.ts](https://github.com/Village-Wellth/next-admin/tree/main/apps/example/app/api/posts/export/route.ts)
...
"use server";
import { ActionParams } from "@village-wellth/next-admin";
import { submitForm } from "@village-wellth/next-admin/dist/actions";
...
- [app/components/inputs/DatePicker.tsx](https://github.com/Village-Wellth/next-admin/blob/main/apps/example/components/DatePicker.tsx)
